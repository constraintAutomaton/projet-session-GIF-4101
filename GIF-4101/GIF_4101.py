...
Periodes = ['2004-05-28 2004-06-28', '2005-12-23 2006-01-23', '2008-09-14 2008-10-14', '2011-04-11 2011-05-11', '2015-09-19 2015-10-19']
		...
		for j in range(len(resultats)):
			...
			if circonscription != circonscription_precedente and isinstance(circonscription, str):
				...
				if j != 0 :
					...
					data.loc[compteur] = [annee, province, circonscription_precedente, trend_chef_liberal, trend_chef_conservateur, trend_chef_npd, trend_chef_bloc, vote_liberal, vote_conservateur, vote_npd, vote_bloc]
...
#exemple
allo = get_info(Liste_electionR, Partis, Chefs, Periodes);
print(allo)

for i in range(len(allo)):
	if allo.iloc[i]["Annee"] == Liste_electionR[4]:
		print(allo.iloc[i]["Trend chef parti libéral"])